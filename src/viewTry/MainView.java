...
public class MainView extends JFrame {
	...
	public MainView() {
		...
		darkBg.setIcon(new ImageIcon("D:\\eclipse\\eclipse-workspace\\ManilaView\\images\\darkBg.png"));
		darkBg.setBounds(235, 176, 468, 328);
		darkPn.add(darkBg);
		
		JLabel darkPnBg = new JLabel("");
		darkPnBg.setIcon(new ImageIcon("D:\\eclipse\\eclipse-workspace\\ManilaView\\images\\infoJpBg.png"));
		...
		stockLb.setIcon(new ImageIcon("D:\\eclipse\\eclipse-workspace\\ManilaView\\images\\stock1.PNG"));
		stockLb.setBounds(425, 359, 175, 50);
		moneyPn.add(stockLb);
		
		JLabel moneyBg = new JLabel("");
		moneyBg.setIcon(new ImageIcon("D:\\eclipse\\eclipse-workspace\\ManilaView\\images\\moneyBg.png"));
		moneyBg.setBounds(235, 176, 468, 328);
		moneyPn.add(moneyBg);
		
		JLabel moneyPnBg = new JLabel("");
		moneyPnBg.setIcon(new ImageIcon("D:\\eclipse\\eclipse-workspace\\ManilaView\\images\\infoJpBg.png"));
		...
		state1.setIcon(new ImageIcon("D:\\eclipse\\eclipse-workspace\\ManilaView\\images\\state0.PNG"));
		state1.setBounds(290, 329, 200, 50);
		partPn.add(state1);
		
		JLabel state2 = new JLabel("");
		state2.setIcon(new ImageIcon("D:\\eclipse\\eclipse-workspace\\ManilaView\\images\\state0.PNG"));
		state2.setBounds(290, 379, 200, 50);
		partPn.add(state2);
		
		JLabel state3 = new JLabel("");
		state3.setIcon(new ImageIcon("D:\\eclipse\\eclipse-workspace\\ManilaView\\images\\state0.PNG"));
		...
		partBg.setIcon(new ImageIcon("D:\\eclipse\\eclipse-workspace\\ManilaView\\images\\partBg.png"));
		partBg.setBounds(142, 135, 655, 438);
		partPn.add(partBg);
		
		JLabel partPnBg = new JLabel("");
		partPnBg.setIcon(new ImageIcon("D:\\eclipse\\eclipse-workspace\\ManilaView\\images\\infoJpBg.png"));
